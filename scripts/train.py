...
def main(
    ...
    lambda_rpn_objectness: float = typer.Option(1, help="Weight for rpn objectness loss"),
    lambda_rpn_bbox: float = typer.Option(20, help="Weight for rpn bbox loss"),
    lambda_fast_rcnn_cls: float = typer.Option(10, help="Weight for fast rcnn cls loss"),
    lambda_fast_rcnn_bbox: float = typer.Option(10, help="Weight for fast rcnn bbox loss"),
